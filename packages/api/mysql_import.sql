-- MySQL import file for the API (schema only; no data).
-- Usage: mysql -u <user> -p < packages/api/mysql_import.sql
...
-- Optional: insert an admin user after importing (replace <hash> with bcrypt hash):
