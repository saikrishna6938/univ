    ...
    <Root className="flex items-center">
      ...
      >
        {/* <img
          ...
          src=""
          alt="react"
          width="16"
        /> */}
        <span className="react-text text-24 mx-4">NxtStep</span>
      </div>
    </Root>
  );
}
