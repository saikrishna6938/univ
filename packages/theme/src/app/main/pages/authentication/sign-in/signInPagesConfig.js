...
const ModernReversedSignInPage = lazy(() =>
  import("./ModernReversedSignInPage")
);
const SplitScreenSignInPage = lazy(() => import("./SplitScreenSignInPage"));
const SplitScreenReversedSignInPage = lazy(() =>
  import("./SplitScreenReversedSignInPage")
);
const FullScreenSignInPage = lazy(() => import("./FullScreenSignInPage"));
const FullScreenReversedSignInPage = lazy(() =>
  import("./FullScreenReversedSignInPage")
);
